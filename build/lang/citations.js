...
module.exports = {
  es: {
    "what-is-bazi": q("Del clásico", "以日为主，年为根，月为苗，日为花，时为果。",
      ...
      "Citas según ediciones corrientes; la redacción puede variar entre versiones. Nuestras lecturas son traducciones modernas."),
    ...
    "ziwei-guide": q("Del clásico", "学问之难，莫难于星命之学；而星命之学，莫难于紫微斗数。",
      ...
      "Zi Wei Dou Shu Quan Shu, el Libro Completo de Zi Wei Dou Shu (compilado por Luo Hongxian, dinastía Ming)",
  ...
  ar: {
    "what-is-bazi": q("من النصوص الكلاسيكية", "以日为主，年为根，月为苗，日为花，时为果。",
      ...
      "الاقتباسات وفق الطبعات الشائعة؛ وقد تتفاوت الصياغة بين النسخ. قراءاتنا ترجمات حديثة."),
    ...
    "ziwei-guide": q("من النصوص الكلاسيكية", "学问之难，莫难于星命之学；而星命之学，莫难于紫微斗数。",
      ...
      "كتاب تسي وي دو شو تشوان شو (الكتاب الكامل لزي وي دو شو، جمعه لو هونغ شيان، أسرة مينغ)",
