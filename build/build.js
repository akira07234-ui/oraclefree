...
["", "zh/"].forEach(function (pre) {
  ...
  var foot = Z ? { blurb: "免费的中文命理工具站。", toolsTitle: "工具", learnTitle: "了解更多", learnLabel: "命理课堂", aboutLabel: "关于本站", privacyLabel: "隐私政策", tools: [], legal: "仅供文化娱乐参考。" } : { blurb: "Free Chinese fortune-telling tools.", toolsTitle: "Tools", learnTitle: "Learn", learnLabel: "Guides", aboutLabel: "About", privacyLabel: "Privacy", tools: [], legal: "For cultural and entertainment purposes only." };
